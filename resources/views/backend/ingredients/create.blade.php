        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <form class="mt-4" action="{{ route('ingredients.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="recipe_code" id="formResep">
                                        ...
                                        @foreach ($recipe as $item)
                                            <option value="{{ $item->recipe_code }}" @if(old('recipe_code') == $item->recipe_code) selected @endif>{{ ucwords($item->name) }}</option>
                                        @endforeach
                                    </select>
                                    @error('recipe_code')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="product_code" id="formProduct">
                                        ...
                                        @foreach ($product as $item)
                                            <option value="{{ $item->product_code }}" @if(old('product_code') == $item->product_code) selected @endif>{{ ucwords($item->name) }}</option>
                                        @endforeach
                                    </select>
                                    @error('product_code')
                                    <p class="text-danger">{{ $message }}</p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="formNama" name="dose" placeholder="ex : 1 buah" value="{{ old('dose') }}">
                                    @error('dose')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
